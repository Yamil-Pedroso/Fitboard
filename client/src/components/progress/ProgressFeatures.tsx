...
const ProgressFeatures = () => {
  return (
    <div className="relative">
      {/* Fondo fijo: siempre full viewport, sin bandas blancas */}
      <img
        src={assets.progress1}
        alt="Progress Feature"
        className="fixed inset-0 h-[100svh] w-[100vw] object-cover object-center"
      />

      {/* Overlay centrado con la card */}
      <div className="fixed inset-0 z-10 flex items-center justify-center p-4 sm:p-6 md:p-8">
        {/* Borde glossy */}
        <div className="relative w-full max-w-[min(92vw,44rem)] sm:max-w-xl md:max-w-2xl">
            ...
            <div className="p-5 sm:p-6 md:p-8">
              ...
              <div className="mt-6 rounded-2xl border border-white/15 bg-white/5 p-3 sm:p-4">
                <p className="text-sm leading-relaxed text-white/90">
                  Great sleep, light DOMS. Keep protein high and aim for a 30–40
                  min walk after dinner. Hydration on point.
                </p>
              </div>
